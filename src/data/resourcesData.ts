...
export const subjectResources: Record<string, {
  ...
  'icb101': {
    ...
    studyMaterials: [
      ...
      { name: 'Chapter 1: Cell And Evolution', link: 'https://drive.google.com/drive/folders/10zuIBNexvDR8Kplv1iFLN3rUqIBbf3by' },
      { name: 'Chapter 2: Basics In Biochemistry', link: 'https://drive.google.com/drive/folders/1HxojfnhBlylx6YNZGJ6Eijim1m4nxQxl' },
      { name: 'Chapter 3: Structure Biology', link: 'https://drive.google.com/drive/folders/1HxojfnhBlylx6YNZGJ6Eijim1m4nxQxl' },
      { name: 'Chapter 4: Neurobiology', link: 'https://drive.google.com/drive/folders/1eWsmsnrbgwTrvetwGUio-ARFtiwj7tjf' },
      { name: 'Chapter 5: Immunobiology', link: 'https://drive.google.com/drive/folders/1Or1DyezYPSDQSnbppRC2q0Rfrv7Z_TIV' },
      { name: 'Study Material Drive Link', link: 'https://drive.google.com/drive/folders/1N9l92axthPtu2cnt7OZ3o7WOhf3ZyRSj' },
  ...
  'chy101': {
    ...
    studyMaterials: [
      { name: 'Chapter 1: Periodic Properties', link: 'https://drive.google.com/drive/folders/1H_5UGp_8elMLazqI4LiO9V5tv3p6HR8q' },
      { name: 'Chapter 2: Use Of Free Energy In Chemical Equilibria', link: 'https://drive.google.com/drive/folders/1fyyOpimz7-A50E7ma5tdYm530mn2c04W' },
      { name: 'Chapter 3: Stereo Chemistry And Organic Reactions', link: 'https://drive.google.com/drive/folders/1O-f4NwJaCqj5JJyRKTLcFDo-Wrs0fn7F' },
      { name: 'Chapter 4: Polymers', link: 'https://drive.google.com/drive/folders/1NUpr1cydE0MZHH78Kb3WZYY2JFJS4Ca4' },
      { name: 'Chapter 5: Advanced Engineering Materials', link: 'https://drive.google.com/drive/folders/1_YBezhmHo_1nnkZTZZfX5phgqBCS_i4b' },
      { name: 'BEST NOTES', link: 'https://drive.google.com/drive/folders/1lrtBwvJ3HVZPi_DH3i04uKxBMcCFLekw' },
      { name: 'Study Material Drive Link', link: 'https://drive.google.com/drive/folders/1lrtBwvJ3HVZPi_DH3i04uKxBMcCFLekw' },
    ],
