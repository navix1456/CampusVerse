...
const perksData = {
  development: [
    ...
    },
    {
      ...
      title: "Autodesk & Intel Developer Suites",
      description: "Free access to professional design and engineering software. Perfect for technical projects!",
      link: "https://www.autodesk.com/education/edu-software/overview"
    },
    {
      logo: "https://www.microsoft.com/favicon.ico",
      title: "Microsoft 365 Education",
      description: "Fully-featured Office apps including Word, Excel, PowerPoint and more - completely free!",
    ...
    },
    {
      ...
      description: "Free design tool plan for students to create UI/UX designs, wireframes and prototypes.",
  ...
  lifestyle: [
    {
      ...
      title: "Headspace",
      description: "85% off meditation app. Improve your mental wellbeing and reduce stress!",
  ...
  return (
    <div className="min-h-screen pb-12">
      ...
      <div className="container mx-auto px-4 pt-24">
        ...
        {/* Development Tools */}
        <div className="mb-12">
          <h2 className="text-2xl font-bold mb-6 gradient-text">Development & Design Tools</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {perksData.development.map((perk, index) => (
              <PerksCard
                key={`dev-${index}`}
                logo={perk.logo}
                title={perk.title}
        ...
        {/* Learning Platforms */}
        <div className="mb-12">
          <h2 className="text-2xl font-bold mb-6 gradient-text">Learning Platforms</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {perksData.learning.map((perk, index) => (
              <PerksCard
                key={`learn-${index}`}
                logo={perk.logo}
                title={perk.title}
        ...
        {/* Entertainment */}
        <div className="mb-12">
          <h2 className="text-2xl font-bold mb-6 gradient-text">Entertainment</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {perksData.entertainment.map((perk, index) => (
              <PerksCard
        ...
        {/* Tools & Security */}
        <div className="mb-12">
          <h2 className="text-2xl font-bold mb-6 gradient-text">Tools & Security</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {perksData.tools.map((perk, index) => (
              <PerksCard
                key={`tools-${index}`}
                logo={perk.logo}
                title={perk.title}
        ...
        {/* Travel */}
        <div className="mb-12">
          <h2 className="text-2xl font-bold mb-6 gradient-text">Travel</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {perksData.travel.map((perk, index) => (
              <PerksCard
                key={`travel-${index}`}
                logo={perk.logo}
                title={perk.title}
        ...
        {/* Lifestyle */}
        <div>
          <h2 className="text-2xl font-bold mb-6 gradient-text">Lifestyle</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {perksData.lifestyle.map((perk, index) => (
              <PerksCard
                key={`lifestyle-${index}`}
                logo={perk.logo}
                title={perk.title}
